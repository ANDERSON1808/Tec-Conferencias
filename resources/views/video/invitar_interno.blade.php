<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form  action="{{ route('invitarInterno') }}" method="post"   enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                   ...
                   <div class="accordion" id="accordion1" role="tablist" aria-multiselectable="true">
                    <div class="panel">
                        ...
                        <center>   <h4  class="panel-title">Invitar usuarios internos</h4></center>
                        </a>
                        ...
                        <div id="collapseOne1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                          <div class="panel-body">
                            ...
                            <center> <a onclick="Agrega()" class="btn btn-link" title="Agregar" ><i class="fa fa-plus-circle" aria-hidden="true"></i>Nuevo usuario</a> </center>
                          </div>
                        </div>
                      </div>
                      </div>  
...
function Agrega(){
 ...
 TD1.innerHTML="<select class='select2_multiple form-control'  name='usuario[]' id='cars' requered >@foreach ($users as $date)<option value='{{ $date->id }}'>{{  $date->name }}</option> @endforeach</select>";
 ...
 TD3.innerHTML=" <a onclick='Elimina(this)' class='btn btn-link' title='Eliminar' ><i class='fa fa-trash' aria-hidden='true'></i></a> "
