          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <p>Gestiona tus listas de precios. </p>
              </div>
            
              <div class="title_right">
                <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                  <div class="input-group">
                  <a href="#" class="modalSubirTrigger" data-toggle="modal" data-target="#exampleModal"><button class="btn btn-info"><i class="fa fa-plus" aria-hidden="true"> Nueva lista de precios</i></button></a>
                        ...
                        <table id="datatable-keytable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            @endphp
                              ...
                              <tr>
                                ...
                                <a href="#" class="btn btn-link" title="Desactivar" ><i class="fa fa-magic" aria-hidden="true"></i></a>
                                <a href="{{route('lista_principal')}}"   class="btn btn-link" title="Eliminar" ><i class="fa fa-trash" aria-hidden="true"></i></a>
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                </td>
                              </tr>
