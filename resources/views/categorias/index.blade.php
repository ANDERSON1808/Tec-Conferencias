          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Categorías</h3>
                <p> Utiliza las categorías para clasificar tus productos y ubicarlos fácilmente </p>
              </div>
            
              <div class="title_right">
                <div class="col-md-5 col-sm-5   form-group pull-right top_search">
                  <div class="input-group">
                  <a href="#" class="modalSubirTrigger" data-toggle="modal" data-target="#exampleModal"><button class="btn btn-info"><i class="fa fa-plus" aria-hidden="true">  Nueva categoria</i></button></a>
                          ...
                          <table id="datatable-keytable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            @endphp
                              <tr>
                                ...
                                @endif
                                <td align="center">
                                <a href="{{ route('modal_ver',$data->id) }}"  class="btn btn-link" title="ver detalle" ><i class="fa fa-eye" aria-hidden="true"></i></a>
