...
<body class="nav-md">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            ...
                            <p> Ingresar a inivitaciones sobre sesiones convocadas</p>
                        </div>
                                ...
                                <div class="input-group">
                                    <a href="#" onclick="crearSesion()" class="modalSubirTrigger" data-toggle="modal"
                                        data-target="#exampleModalL"><button class="btn btn-info"><i class="fa fa-plus"
                                                aria-hidden="true">Peticion para participar</i></button></a>
    ...
    <script type="text/javascript">
        ...
        function verSesiones() {
            $.post("getSesionesInvitados", {idUser: {{ Auth::user()->id }} })
            .done( function(data){
                    ...
                    $.each(data,function(key, reg) {
                        ...
                        '           aria-hidden="true">Participar</i>'+
                        '   </a>'+
                        '   <a href="#" onClick="AlertDelete('+reg.id+')"'+
                            '   class="btn btn-outline-success"'+
                            '   title="Iniciar conferencia">'+
                            '   <i class="fa fa-trash"'+
                            '       aria-hidden="true">No Participar</i>'+
                            '</a>'+
                        '</button></td></tr> ';
                     });
