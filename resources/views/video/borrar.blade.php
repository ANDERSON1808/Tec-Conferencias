...
<div class="modal" id="myModalE" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <form class="formsiswa" action="{{route('do_delete',$conferencia->id)}}" method="post">
      <div class="modal-content">
        ...
        <div class="alert alert-danger alert-dismissible">
               ...
               <p>¿Estás seguro de que deseas la videoconferencia {{$conferencia->nombre}} ?</p>
              </div>
        ...
        <div class="modal-footer">
          ...
          <input type="hidden" name="deletedata" value="{{$conferencia->id}}">
        </div>
      </div><!-- /.modal-content -->
    </form>
    </div>
